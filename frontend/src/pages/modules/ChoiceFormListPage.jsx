/**
 * ChoiceFormListPage.jsx  —  AUTO-GENERATED (2026-06-24T11:30:42.959Z)
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="flex items-center justify-between gap-4 px-6 py-4 border-b border-slate-100 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => navigate('/choice-form/new')}
              ...
              <tbody className="divide-y divide-slate-50">
                {displayed.map((record) => (
                  <tr key={record._id}
                    ...
                    <td className="px-4 py-4">
                      <CellValue value={record.city} fieldType="select" />
                    </td>
                    ...
                    <td className="px-4 py-4">
                      <ActionMenu
                        onEdit={() => navigate('/choice-form/' + record._id + '/edit')}
                        onDelete={() => handleDelete(record._id, record.hobby)}
                      />
                    </td>
                  </tr>
                ))}

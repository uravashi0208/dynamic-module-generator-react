/**
 * BasicFormListPage.jsx  —  AUTO-GENERATED (2026-06-27T10:14:47.740Z)
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="flex items-center justify-between gap-4 px-6 py-4 border-b border-slate-100 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => navigate('/basic-form/new')}
        ...
        {isLoading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <th
                className="px-4 py-3 text-xs font-medium text-slate-500 uppercase tracking-wide cursor-pointer select-none whitespace-nowrap"
                onClick={() => handleSort('phone_nummber')}
              >
                <div className="flex items-center gap-1">
                  Phone Nummber
                  <ChevronsUpDown className="w-3 h-3 text-slate-400" />
              ...
              <tbody className="divide-y divide-slate-50">
                {displayed.map((record) => (
                  <tr key={record._id}
                    ...
                    <td className="px-4 py-4">
                      <CellValue value={record.email} fieldType="email" />
                    </td>
                    <td className="px-4 py-4">
                      <CellValue value={record.passoword} fieldType="password" />
                    </td>
                    <td className="px-4 py-4">
                      <CellValue value={record.address} fieldType="textarea" />
                    </td>
                    <td className="px-4 py-4">
                      <CellValue value={record.phone_nummber} fieldType="number" />
                    </td>
                    ...
                    <td className="px-4 py-4">
                      <ActionMenu
                        onEdit={() => navigate('/basic-form/' + record._id + '/edit')}
